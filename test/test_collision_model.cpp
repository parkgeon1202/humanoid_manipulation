...
TEST(CollisionChecker, IntegratesWithIkStepRegressionAfterMeshSwitch) {
  ...
  // 과는 안 맞고 새 C++ 메시 기반 구현끼리의 회귀 테스트임.
  struct Tick {
    Eigen::VectorXd q;
    double damping;
    bool converged;
  ...
  const std::vector<Tick> golden = {
      ...
      {v8({-0.0109361894, 0.0004415489, -0.1554687765, 0.0002787908, 0, 0, 0, 0}), 0.256, false,
       false},
      {v8({-0.0109361894, 0.0004415489, -0.1554687765, 0.0002787908, 0, 0, 0, 0}), 0.512, false,
       true},
      {v8({-0.0147456501, -0.0003914146, -0.2019864153, -0.0002271524, 0, 0, 0, 0}), 0.512, false,
       false},
      {v8({-0.0147456501, -0.0003914146, -0.2019864153, -0.0002271524, 0, 0, 0, 0}), 1.024, false,
       true},
      {v8({-0.0147456501, -0.0003914146, -0.2019864153, -0.0002271524, 0, 0, 0, 0}), 2.048, false,
       true},
      {v8({-0.0147456501, -0.0003914146, -0.2019864153, -0.0002271524, 0, 0, 0, 0}), 4.096, false,
       true},
      {v8({-0.0148164894, -0.0004142987, -0.2028018983, -0.0002410977, 0, 0, 0, 0}), 4.096, false,
       false},
  };
